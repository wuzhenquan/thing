...
function MDIcon({ name, size = '1em', color = 'primary' }) {
  ...
  switch (name) {
    case 'account':
      path = mdIcons.mdiAccount
      break
    case 'email':
      path = mdIcons.mdiEmail
      break
    case 'lock':
      path = mdIcons.mdiLock
      break
    case 'check':
      path = mdIcons.mdiCheck
      break
    case 'alert':
      path = mdIcons.mdiAlert
      break
    case 'plus':
      path = mdIcons.mdiPlus
      break
    case 'radioBoxBlank':
      path = mdIcons.mdiRadioboxBlank
      break
    case 'delete':
      path = mdIcons.mdiDeleteOutline
      break
    default:
      break
  }
